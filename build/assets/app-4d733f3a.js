...
var vt = !1;
function ir() {
    vt && S("Alpine has already been initialized on this page. Calling Alpine.start() more than once can cause problems."),
    vt = !0,
...
function vr(e, t, n) {
    ...
    , {scope: o={}, params: s=[]}={}) => {
        ...
        if (typeof r == "function") {
            ...
            r.finished ? (ge(i, r.result, a, s, n),
...
function wr(e, t) {
    ...
    let s = () => {
        ...
        r = r.bind(r, e, t, i),
        Fe ? Z.get(an).push(r) : r())
    }
    ;
    return s.runCleanups = o,
    s
}
var cn = (e, t) => ({name: n, value: r}) => (n.startsWith(e) && (n = n.replace(e, t)),
{
    name: n,
    value: r
})
...
function fn(e= () => {}
    ...
    return ({name: t, value: n}) => {
        let {name: r, value: i} = dn.reduce( (o, s) => s(o), {
            name: t,
            value: n
        });
        return r !== t && e(r, t),
...
x("transition", (e, {value: t, modifiers: n, expression: r}, {evaluate: i}) => {
    ...
    r !== !1 && (!r || typeof r == "boolean" ? $r(e, n, t) : Ir(e, r, t))
}
);
function Ir(e, t, n) {
    hn(e, at, ""),
...
function vn(e, t, n, r=[]) {
    switch (e._x_bindings || (e._x_bindings = U({})),
    e._x_bindings[t] = n,
    t = r.includes("camel") ? Ur(t) : t,
    t) {
    case "value":
        Lr(e, n);
        break;
...
function Lr(e, t) {
    if (e.type === "radio")
        ...
        window.fromModel && (typeof t == "boolean" ? e.checked = _e(e.value) === t : e.checked = mt(e.value, t));
    else if (e.type === "checkbox")
        Number.isInteger(t) ? e.value = t : !Array.isArray(t) && typeof t != "boolean" && ![null, void 0].includes(t) ? e.value = String(t) : Array.isArray(t) ? e.checked = t.some(n => mt(n, e.value)) : e.checked = !!t;
...
function bn(e, t, n) {
    [null, void 0, !1].includes(n) && Vr(t) ? e.removeAttribute(t) : (mn(t) && (n = t),
    Kr(e, t, n))
}
function Kr(e, t, n) {
...
function An({get: e, set: t}, {get: n, set: r}) {
    let i = !0, o, s = k( () => {
        let a = e()
          , u = n();
        if (i)
...
function Yr(e, t) {
    ...
    t === void 0)
        return P[e];
    P[e] = t,
    typeof t == "object" && t !== null && t.hasOwnProperty("init") && typeof t.init == "function" && P[e].init(),
    Qt(P[e])
}
function Gr() {
    return P
...
var ri = Object.freeze({}), ii = Object.prototype.hasOwnProperty, me = (e, t) => ii.call(e, t), L = Array.isArray, ee = e => Mn(e) === "[object Map]", oi = e => typeof e == "string", ut = e => typeof e == "symbol", we = e => e !== null && typeof e == "object", si = Object.prototype.toString, Mn = e => si.call(e), In = e => Mn(e).slice(8, -1), ct = e => oi(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, ai = e => {
    const t = Object.create(null);
    return n => t[n] || (t[n] = e(n))
}
, ui = ai(e => e.charAt(0).toUpperCase() + e.slice(1)), $n = (e, t) => e !== t && (e === e || t === t), He = new WeakMap, X = [], C, N = Symbol("iterate"), Ue = Symbol("Map key iterate");
function ci(e) {
...
function E(e, t, n) {
    ...
    i.has(C) || (i.add(C),
    C.deps.push(i),
    C.options.onTrack && C.options.onTrack({
        effect: C,
        target: e,
        type: t,
        key: n
...
function R(e, t, n, r, i, o) {
    ...
    if (t === "clear")
        ...
        switch (n !== void 0 && u(s.get(n)),
        t) {
        case "add":
            L(e) ? ct(n) && u(s.get("length")) : (u(s.get(N)),
            ee(e) && u(s.get(Ue)));
            break;
        case "delete":
            L(e) || (u(s.get(N)),
...
function Bn(e=!1, t=!1) {
    return function(r, i, o) {
        ...
        if (i === "__v_isReadonly")
            return e;
        if (i === "__v_raw" && o === (e ? t ? Bi : kn : t ? ji : Nn).get(r))
            return r;
        const s = L(r);
        if (!e && s && me(St, i))
            return Reflect.get(St, i, o);
        const a = Reflect.get(r, i, o);
        return (ut(i) ? jn.has(i) : gi(i)) || (e || E(r, "get", i),
        t) ? a : Ve(a) ? !s || !ct(i) ? a.value : a : we(a) ? e ? Dn(a) : _t(a) : a
    }
}
var bi = mi();
function mi(e=!1) {
    return function(n, r, i, o) {
        ...
        return n === h(o) && (a ? $n(i, s) && R(n, "set", r, i, s) : R(n, "add", r, i)),
        u
    }
}
function wi(e, t) {
    ...
    return i && n && R(e, "delete", t, void 0, r),
    i
}
function Si(e, t) {
    const n = Reflect.has(e, t);
    return (!ut(t) || !jn.has(t)) && E(e, "has", t),
    n
}
function Ei(e) {
...
function At(e, t) {
    ...
    const s = i.call(n, e);
    return n.set(e, t),
    o ? $n(t, s) && R(n, "set", e, t, s) : R(n, "add", e, t),
    this
}
function Ct(e) {
    const t = h(this)
    ...
    const o = r ? r.call(t, e) : void 0
      , s = t.delete(e);
    return i && R(t, "delete", e, void 0, o),
    s
}
function Ot() {
    const e = h(this)
...
A("data", e => Zt(e));
A("root", e => ye(e));
A("refs", e => (e._x_refs_proxy || (e._x_refs_proxy = ie(Ni(e))),
e._x_refs_proxy));
function Ni(e) {
    let t = [];
    return ne(e, n => {
...
function Tt(e) {
    ...
    return t || S('Cannot find x-teleport element for selector: "'.concat(e, '"')),
    t
}
var Un = () => {}
;
Un.inline = (e, {modifiers: t}, {cleanup: n}) => {
...
;
x("ignore", Un);
x("effect", D( (e, {expression: t}, {effect: n}) => {
    n(m(e, t))
}
));
function qe(e, t, n, r) {
...
function Wi(e, t) {
    ...
    e["".concat(s, "Key")])).length === i.length && Mt(e.key).includes(n[0]))
}
function Mt(e) {
    if (!e)
        return [];
...
function It(e, t, n, r) {
    return y( () => {
        ...
        if (e.type === "checkbox")
            if (Array.isArray(r)) {
                let i = null;
                return t.includes("number") ? i = Te(n.target.value) : t.includes("boolean") ? i = _e(n.target.value) : i = n.target.value,
                n.target.checked ? r.concat([i]) : r.filter(o => !Ji(o, i))
            } else
                ...
                ) : Array.from(n.target.selectedOptions).map(i => i.value || i.text);
            {
                ...
                t.includes("number") ? Te(i) : t.includes("boolean") ? _e(i) : t.includes("trim") ? i.trim() : i
            }
        }
    }
    )
...
Ht( () => "[".concat(q("init"), "]"));
x("init", D( (e, {expression: t}, {evaluate: n}) => typeof t == "string" ? !!t.trim() && n(t, {}, !1) : n(t, {}, !1)));
x("text", (e, {expression: t}, {effect: n, evaluateLater: r}) => {
    let i = r(t);
    n( () => {
        i(o => {
            y( () => {
...
it(cn(":", ln(q("bind:"))));
var Vn = (e, {value: t, modifiers: n, expression: r, original: i}, {effect: o, cleanup: s}) => {
    if (!t) {
        let u = {};
        Zr(u),
        m(e, r)(l => {
...
zt( () => "[".concat(q("data"), "]"));
x("data", (e, {expression: t}, {cleanup: n}) => {
    if (Xi(e))
        return;
    t = t === "" ? "{}" : t;
    let r = {};
...
function Zi(e, t, n, r) {
    let i = s => typeof s == "object" && !Array.isArray(s)
      , o = e;
    n(s => {
        eo(s) && s >= 0 && (s = Array.from(Array(s).keys(), d => d + 1)),
        s === void 0 && (s = []);
        let a = e._x_lookup
          , u = e._x_prevKeys
          , c = []
          , l = [];
        if (i(s))
            s = Object.entries(s).map( ([d,_]) => {
                let g = Rt(t, _, d, s);
                r(b => {
                    l.includes(b) && S("Duplicate key on x-for", e),
                    l.push(b)
                }
                , {
                    scope: {
            ...
            for (let d = 0; d < s.length; d++) {
                let _ = Rt(t, s[d], d, s);
                r(g => {
                    l.includes(g) && S("Duplicate key on x-for", e),
                    l.push(g)
                }
                , {
                    scope: {
        ...
        for (let d = 0; d < v.length; d++) {
            let _ = v[d];
            a[_]._x_effects && a[_]._x_effects.forEach(Ft),
            a[_].remove(),
            a[_] = null,
            delete a[_]
        }
        for (let d = 0; d < p.length; d++) {
            ...
            y( () => {
                w || S('x-for ":key" is undefined or invalid', o, g, a),
                w.after(K),
                b.after(w),
        ...
        for (let d = 0; d < f.length; d++) {
            ...
            typeof K == "object" && S("x-for key cannot be an object, it must be a string or an integer", o),
            a[K] = J
        }
        for (let d = 0; d < T.length; d++)
            a[T[d]]._x_refreshXForScope(c[l.indexOf(T[d])]);
        o._x_prevKeys = l
    }
    )
}
...
;
x("ref", qn);
x("if", (e, {expression: t}, {effect: n, cleanup: r}) => {
...
it(cn("@", ln(q("on:"))));
x("on", D( (e, {value: t, modifiers: n, expression: r}, {cleanup: i}) => {
    let o = r ? m(e, r) : () => {}
    ;
...
function no(e) {
    ...
    function t(n, {modifiers: r}) {
        let i = Pt(r, "duration", 250) / 1e3
          , o = Pt(r, "min", 0)
          , s = !r.includes("min");
        n._x_isShown || (n.style.height = "".concat(o, "px")),
        ...
        n._x_transition = {
            ...
            , l= () => {}
                ...
                e.transition(n, a, {
                    ...
                    n._x_isShown = !1,
                    n.style.height == "".concat(o, "px") && s && (n.style.display = "none",
                    n.hidden = !0)
                }
                )
            }
...
var ro = no;
function io(e) {
    e.directive("intersect", e.skipDuringClone( (t, {value: n, expression: r, modifiers: i}, {evaluateLater: o, cleanup: s}) => {
        let a = o(r)
          , u = {
            rootMargin: ao(i),
            threshold: oo(i)
    ...
    Alpine.data("pageVisibilityHandler", e => {
        ...
        return {
            ...
            handleVisibilityChange() {
                document.hidden ? this.startAwayTimer() : (this.restoreOriginalState(),
                this.clearAwayTimer())
            },
            startAwayTimer() {
                this.clearAwayTimer(),
                this.visibilityTimer = setTimeout(this.setAwayState.bind(this), this.awayDelay)
            },
            clearAwayTimer() {
            ...
            setAwayState() {
                ...
                document.getElementById("favicon").setAttribute("href", this.awayFavicon)
            },
            restoreOriginalState() {
                document.title = this.originalTitle,
                document.getElementById("favicon").setAttribute("href", this.originalFavicon)
            }
        }
    }
    )
...
W.start();
fo(window);
export {_o as __vite_legacy_guard};
